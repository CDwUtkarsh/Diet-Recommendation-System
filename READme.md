...
<div align= "center"><img src="Assets/content_based_img.jpg"/></div>
...
![](https://img.icons8.com/color/48/null/python--v1.png)![](https://img.icons8.com/color/48/null/numpy.png)![](Assets/streamlit-icon-48x48.jpg)![](Assets/fastapi.ico)![](Assets/scikit-learn.ico) ![](https://img.icons8.com/color/48/null/pandas.png)
...
#### Clone the repo
```
$ git clone https://github.com/CDwUtkarsh/Diet-Recommendation-System
```
### docker-compose
